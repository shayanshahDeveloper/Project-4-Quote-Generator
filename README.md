...
## ScreenShots
![quote](https://github.com/user-attachments/assets/49d5582c-d868-464c-9a42-4d1b6ed8e003)
![gif](https://github.com/user-attachments/assets/ba6a88ef-8a93-418e-b313-27dbe9cc6bc4)
...
document.getElementById("quote").innerHTML =
  "You see things; you say, 'Why?' But I dream things that never were; and I say 'Why not?";
document.getElementById("author").innerHTML = "George Bernard Shaw?";

```
## Check Out The Website 👇

Visit The Website🌐 [Random Quote Generator](https://shayanshahdeveloper.github.io/Project-4-Quote-Generator/)
